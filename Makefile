...
.NOEXPORT:
taglib.lo: /home/tso/q/taglib.cpp
	$(LIBTOOL) --mode=compile $(CXX)  -I. -I/home/tso/q $(COMMON_FLAGS) $(CXXFLAGS_CLEAN) $(EXTRA_CXXFLAGS)  -c /home/tso/q/taglib.cpp -o taglib.lo 
