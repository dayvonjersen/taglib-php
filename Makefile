srcdir = /home/tso/taglib-php/php-5.6.7/ext/taglib
builddir = /home/tso/taglib-php/php-5.6.7/ext/taglib
top_srcdir = /home/tso/taglib-php/php-5.6.7/ext/taglib
top_builddir = /home/tso/taglib-php/php-5.6.7/ext/taglib
EGREP = /bin/grep -E
SED = /bin/sed
CONFIGURE_COMMAND = './configure' '--enable-taglib'
...
prefix = /usr/local
phplibdir = /home/tso/taglib-php/php-5.6.7/ext/taglib/modules
...
EXTENSION_DIR = /usr/local/lib/php/extensions/debug-non-zts-20131226
...
./taglib.la: $(shared_objects_taglib) $(TAGLIB_SHARED_DEPENDENCIES)
	$(LIBTOOL) --mode=link $(CC) $(COMMON_FLAGS) $(CFLAGS_CLEAN) $(EXTRA_CFLAGS) $(LDFLAGS) -o $@ -export-dynamic -avoid-version -prefer-pic -module -rpath $(phplibdir) $(EXTRA_LDFLAGS) $(shared_objects_taglib) $(TAGLIB_SHARED_LIBADD)
